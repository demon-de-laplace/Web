...
<html>
  <head>
    ...
    <style type="text/css">
	body {
	background-image: url(imgages/bg-0414.png);
	}
</style>
  ...
  <body onmouseover="checkuser(<%=flag%>)" style="background:url(images/bg-0414.png)">
  <br> <div id="welcome" align="right"><label><%=username %>，欢迎您！&nbsp;<a href="userAction!withdraw">注销</a>&nbsp;</label></div><br>
  <br><br>
  <center><h1>查询结果</h1></center>
    	<table align="center" width="1200" border="1" style="padding:20px 10px 40px 10px;
    color:#000;
    font-size: 16px;
	font-family:楷体;
...
<center>
	<a href="toExcelA">将查询结果导出为Excel</a>
