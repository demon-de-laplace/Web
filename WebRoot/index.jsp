...
<html>
  <head>
    ...
    <link rel="stylesheet" href="css/searchStyle.css" media="screen" type="text/css" />
      ...
      <body onmouseover="checkuser(<%=flag%>)" onload="check()">
        <div class="container">
        <br>
         <center><h1>PaperPro:论文管理系统</h1></center>
            <ul id="menu">
                ...
                <li>
                    <a href="statisticsA" style="text-decoration:none">
                        <i class="icon_help"></i>
		...
		<div id="welcome" align="right"><label><%=username %>，欢迎您！&nbsp;<a href="userAction!withdraw">注销</a>&nbsp;</label></div>
...
<div style="position:absolute;height:50px;width:300;left:525;right:100;top:500;text-align:center">
	<a href="searchLogA!uploadLog">上传日志</a>&nbsp;
	<a href="searchLogA!updateLog">修改日志</a>&nbsp;
	<a href="searchLogA!deleteLog">删除日志</a>
</div>
    </body>
</html>
