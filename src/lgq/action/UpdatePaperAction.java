...
public class UpdatePaperAction extends ActionSupport{
	...
	public String execute()throws Exception{
		...
		updateLog.setUsername(user.getUsername());
		updateLog.setTitle(paper.getTitle());
		updateLog.setAuthor(paper.getAuthor());
		updateLog.setDate(df.format(new Date()));
		log.saveLog2(updateLog);
		return SUCCESS;
	}
}
